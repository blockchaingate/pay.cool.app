...
final $typed_data.Uint8List freezeBalanceContractDescriptor = $convert.base64Decode(
    'ChVGcmVlemVCYWxhbmNlQ29udHJhY3QSIwoNb3duZXJfYWRkcmVzcxgBIAEoDFIMb3duZXJBZGRyZXNzEiUKDmZyb3plbl9iYWxhbmNlGAIgASgDUg1mcm96ZW5CYWxhbmNlEicKD2Zyb3plbl9kdXJhdGlvbhgDIAEoA1IOZnJvemVuRHVyYXRpb24=');
...
final $typed_data.Uint8List unfreezeBalanceContractDescriptor =
    $convert.base64Decode(
        'ChdVbmZyZWV6ZUJhbGFuY2VDb250cmFjdBIjCg1vd25lcl9hZGRyZXNzGAEgASgMUgxvd25lckFkZHJlc3M=');
...
final $typed_data.Uint8List acuthrityDescriptor = $convert.base64Decode(
    'CglhY3V0aHJpdHkSJAoHYWNjb3VudBgBIAEoCzIKLkFjY291bnRJZFIHYWNjb3VudBInCg9wZXJtaXNzaW9uX25hbWUYAiABKAxSDnBlcm1pc3Npb25OYW1l');
...
const Transaction_Contract$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 1,
      '5': 14,
      '6': '.Transaction.Contract.ContractType',
      '10': 'type'
    },
    const {
      '1': 'parameter',
...
final $typed_data.Uint8List transactionDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List transactionsDescriptor = $convert.base64Decode(
    'CgxUcmFuc2FjdGlvbnMSMAoMdHJhbnNhY3Rpb25zGAEgAygLMgwuVHJhbnNhY3Rpb25SDHRyYW5zYWN0aW9ucw==');
...
final $typed_data.Uint8List blockHeaderDescriptor = $convert.base64Decode(
    '');
